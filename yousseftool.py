...
| |_| | (_) | |_| \__ \__ \  __/  _| || (_) | (_) | |
 \__, |\___/ \__,_|___/___/\___|_|  \__\___/ \___/|_|
 |___/                                            
========================================
Created By youssef
enjoy with tools
Facebook: youssef No maltego
----
JUST FOR TERMUX!
----
==========================================
00. MAKE your android as watchdogs phone .
------------------------------------------
1. Install Nmap 
2. Install Hydra
3. Install SQLMap
...
while loop:
    ...
    if what == "00":
        ...
        if hm == "y":
            ...
            os.system("cd /data/data/com.termux/files/home && pkg update && pkg upgrade -y && pkg install wget curl openssh git -y")
            os.system("cd /data/data/com.termux/files/home && wget https://raw.githubusercontent.com/gushmazuko/metasploit_in_termux/master/metasploit.sh && chmod 777 metasploit.sh && ./metasploit.sh")
